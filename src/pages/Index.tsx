  ...
  return (
    <>
      <Helmet>
        ...
        <title>Barbershop Mönchengladbach | Afroshop Vilvette</title>
        <meta
          name="description"
          content="Besuche unseren Premium Barbershop Afroshop Vilvette in Mönchengladbach für erstklassige Haarschnitte, Bartpflege und individuelle Styles. Jetzt Termin buchen!"
        />
        <meta
          name="keywords"
        ...
        {/* Open Graph */}
        <meta property="og:title" content="Afroshop Vilvette | Premium Barbershop Mönchengladbach" />
        <meta
        ...
        <meta name="twitter:title" content="Afroshop Vilvette | Premium Barbershop Mönchengladbach" />
        <meta
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "sameAs": [
              "https://www.facebook.com/afroshopvilvette",
              "https://www.instagram.com/afroshopvilvette"
            ]
          })}
        </script>
      </Helmet>
